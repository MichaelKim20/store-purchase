...
import { Transaction } from "store-purchase-sdk";
...
export class RollupRouter {
    ...
    private isValidate(req: express.Request, res: express.Response, next: any) {
        ...
        if (!errors.isEmpty()) {
            ...
            if (e.length) {
                return res.status(200).json(RollupRouter.makeResponseData(400, undefined, e[0]));
            } else {
                return res.status(200).json(
    ...
    public registerRoutes() {
        ...
        this.app.post(
            ...
            [
                ...
                body("purchase_id")
                    .exists()
                    .withMessage("purchase_id is a required value")
                    .not()
                    .isEmpty()
                    .withMessage("purchase_id is a required value")
                    .bail(),
                ...
                body("franchisee_id")
                    .exists()
                    .withMessage("franchisee_id is a required value")
                    .not()
                    .isEmpty()
                    .withMessage("franchisee_id is a required value")
                    .bail(),
